...
public class FollowReader {
    ...
    public RecommendListResponse getRecommendUserList(final Member loginMember,
        ...
        Slice<FollowUser> badgeRecommendUsers = followQueryRepository.findBadgeRecommendUserList(loginMember,
                badgeLastUserId, pageSize);
        Slice<FollowUser> tastingRecommendUsers = Objects.isNull(tastingLastUserId)
                ? followQueryRepository.findRandomRecommendUserList(pageSize)
                : followQueryRepository.findTastingRecommendUserList(loginMember, tastingLastUserId, pageSize);
