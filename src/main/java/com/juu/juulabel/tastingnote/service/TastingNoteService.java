...
import com.juu.juulabel.tastingnote.domain.embedded.AlcoholicDrinksSnapshot;
import com.juu.juulabel.tastingnote.repository.jpa.TastingNoteCommentJpaRepository;
import com.juu.juulabel.tastingnote.repository.jpa.TastingNoteJpaRepository;
import com.juu.juulabel.tastingnote.request.AlcoholicDrinksInfo;
...
//		);
    ...
    @Transactional(readOnly = true)
    public TastingNote findById(long id) {
        return tastingNoteJpaRepository.findById(id)
                .orElseThrow(() -> new BaseException(ErrorCode.TASTING_NOTE_NOT_FOUND));
    }
}
