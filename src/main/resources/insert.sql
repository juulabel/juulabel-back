...
이 약관은 주라벨 (이하 "회사" 라고 합니다)가 제공하는 제반 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
...
3. 회사가 제공하는 서비스의 내용은 다음과 같습니다.
    1. 전통주 정보 제공 서비스
    2. 전통주 라벨 스캔 (촬영) 기능 서비스
    3. 온라인 전통주 구매 서비스
    4. 사용자 리뷰 및 시음 노트 기반 커뮤니티 서비스
...
1. 회원은 유료서비스를 구입하고 그에 따른 대금을 결제한 경우나 회사 또는 제휴회사에서 주최하는 이벤트, 추가 적립 서비스 등 마케팅 활동 등과 관련하여, 회사의 포인트 적립 정책에 따라 포인트를 부여받게 됩니다.
2. "할인쿠폰"은 회사가 구매활동 또는 이벤트 참여 등에 따른 보상으로 발행 합니다. 이 때 발행된 쿠폰은 사용하거나 만료되면 소멸되며 현금으로 환급되지 않습니다.
3. 포인트 은 현금으로 환급될 수 없습니다. 포인트의 사용기간이 만료되거나 구매 취소 시 또는 이용계약이 종료되면 소멸합니다.
...
1. 회사가 제공하는 유료서비스를 이용하는 경우 이용자는 이용대금을 납부하는 것을 원칙으로 합니다. 이 때 회사가 제공하는 유료서비스에 대한 이용요금의 결제방법은 아래 각 호와 같습니다.
    ...
    2. 폰뱅킹, 인터넷뱅킹, 온라인 무통장입금 등의 각종 계좌이체
...
1. 회사는 이용자가 전통주 라벨을 촬영하여 해당 전통주에 대한 정보를 제공받을 수 있는 라벨 촬영 기능 서비스를 제공합니다.
2. 이용자는 라벨 촬영 기능을 통해 촬영한 이미지가 회사의 데이터베이스와 일치하는 경우 해당 전통주의 상세 정보를 확인할 수 있습니다.
3. 이용자는 촬영된 이미지가 정확하고 선명하게 나오도록 노력해야 하며, 촬영된 이미지의 품질이 낮아 정보 제공이 원활하지 않을 경우 회사는 이에 대해 책임을 지지 않습니다.
4. 회사는 이용자가 촬영한 이미지를 데이터베이스의 정확성을 높이기 위해 활용할 수 있으며, 이 과정에서 개인 식별 정보는 포함되지 않습니다.
5. 이용자는 라벨 촬영 기능을 통해 획득한 정보를 개인적인 용도로만 사용해야 하며, 상업적인 목적으로 사용할 수 없습니다.
6. 회사는 라벨 촬영 기능을 통해 제공된 정보의 정확성을 보장하지 않으며, 이용자가 제공된 정보를 바탕으로 취한 행동에 대해 책임지지 않습니다.

제26조(광고성 정보)

1. 회사가 회원에게 제공하는 서비스의 일부는 광고를 통한 수익으로 운영됩니다. 이에 따라 회원은 서비스 화면 상 광고 노출에 대해 동의합니다.
2. 회사는 회원으로부터 수집한 개인정보를 통해 서비스 이용 중 필요하다고 판단되는 다양한 광고성 정보를 다양한 채널(SMS, LMS, 앱 푸시알림, 이메일 등)을 통해 발송할 수 있으며 회원은 이에 동의합니다. 다만, 회원은 언제든지 광고성 정보 수신 동의를 철회할 수 있습니다.
3. 회원이 광고성 정보 수신 동의를 철회하고자 할 경우, 회사가 제공하는 방법(설정, 고객센터 등)을 통해 언제든지 철회할 수 있습니다.
4. 회사는 광고성 정보의 발송과 관련하여 정보통신망 이용촉진 및 정보보호 등에 관한 법률, 전자상거래 등에서의 소비자보호에 관한 법률 등 관련 법령을 준수합니다.
...
VALUES (
           '개인정보 수집 및 이용동의',
           '주라벨(이하 "회사"라고 합니다)은 개인정보보호법 등 관련 법령상의 개인정보보호 규정을 준수하며 귀하의 개인정보보호에 최선을 다하고 있습니다. 회사는 개인정보보호법에 근거하여 다음과 같은 내용으로 개인정보를 수집 및 처리하고자 합니다.
...
- 필수항목: 성명, 전화번호, 이메일, 성별, 나이, 생년월일
- 선택항목: 마케팅 및 이벤트 정보 수신 여부

제3조(개인정보 보유 및 이용 기간)

1. 수집한 개인정보는 수집·이용 동의일로부터 개인정보 수집·이용 목적을 달성할 때까지 보관 및 이용합니다.
2. 회원 탈퇴 시 수집된 개인정보는 지체 없이 파기됩니다. 단, 관계 법령에 따라 보관해야 하는 경우 해당 법령에서 정한 기간 동안 보관합니다.

제4조(정보주체의 권리 및 행사방법)

1. 귀하는 언제든지 개인정보의 열람, 정정, 삭제, 처리정지 요구 등의 권리를 행사할 수 있습니다.
2. 권리 행사는 서면, 전화, 이메일 등을 통하여 하실 수 있으며, 회사는 이에 대해 지체 없이 조치하겠습니다.
3. 귀하는 개인정보의 수집·이용에 대한 동의를 거부할 권리가 있으며, 동의를 거부할 경우 일부 서비스 이용에 제한이 있을 수 있습니다.

제5조(개인정보의 제3자 제공)

회사는 개인정보보호법에 근거하여 다음과 같은 내용으로 개인정보를 제3자에게 제공하고자 합니다.

1. 개인정보를 제공 받는 제3자: 주라벨에 입점한 양조장
2. 개인정보 제공 목적: 구매자 정보 전달 및 구매건 처리
3. 개인정보 제공 항목: 이름, 연락처(전화번호, 이메일 주소), 배송 주소, 구매 제품명, 구매 수량, 결제 금액, 결제 방법, 주문 번호, 배송 요청 사항 (예: 문 앞에 놓아주세요 등)
4. 개인정보 보유 및 이용 기간: 개인정보 제공 목적 달성 시까지
...
이 동의서는 주라벨(이하 "회사"라 합니다)이 회원에게 제공하는 서비스와 관련하여, 광고성 정보 및 마케팅 정보를 수신하는 것에 대한 회원의 동의 절차를 규정함을 목적으로 합니다.

제2조(정의)

1. "광고성 정보"란 회사가 회원에게 제공하는 서비스의 일부로, 광고를 통한 수익으로 운영되는 정보를 말합니다.
2. "마케팅 정보"란 회사가 회원에게 제공하는 다양한 상품 및 서비스 관련 정보를 말합니다.
3. "회원"이란 회사의 서비스 약관에 동의하고, 회원 등록을 완료한 자를 의미합니다.

제3조(광고성 정보 수신 동의)

1. 회사는 회원에게 다양한 채널(SMS, LMS, 앱 푸시알림, 이메일 등)을 통해 광고성 정보를 발송할 수 있으며, 회원은 이에 동의합니다.
2. 회원은 언제든지 광고성 정보 수신 동의를 철회할 수 있으며, 철회 방법은 회사가 제공하는 설정, 고객센터 등을 통해 가능합니다.
3. 회사는 광고성 정보의 발송과 관련하여 정보통신망 이용촉진 및 정보보호 등에 관한 법률, 전자상거래 등에서의 소비자보호에 관한 법률 등 관련 법령을 준수합니다.

제4조(마케팅 정보 수신 동의)

1. 회사는 회원에게 다양한 마케팅 정보를 제공하기 위해 회원의 동의를 받아 SMS, LMS, 앱 푸시알림, 이메일 등을 통해 마케팅 정보를 발송할 수 있습니다.
2. 회원은 언제든지 마케팅 정보 수신 동의를 철회할 수 있으며, 철회 방법은 회사가 제공하는 설정, 고객센터 등을 통해 가능합니다.
3. 회사는 마케팅 정보의 발송과 관련하여 개인정보보호법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률 등 관련 법령을 준수합니다.

제5조(정보 제공 방법)

1. 회사는 광고성 정보 및 마케팅 정보를 발송할 때 회원에게 명확히 표시하며, 정보 수신 거부 방법을 함께 안내합니다.
2. 회원이 정보 수신을 거부한 경우, 회사는 즉시 해당 회원에게 광고성 정보 및 마케팅 정보를 발송하지 않습니다.

제6조(동의 철회)

1. 회원은 언제든지 회사가 제공하는 설정, 고객센터 등을 통해 광고성 정보 및 마케팅 정보 수신 동의를 철회할 수 있습니다.
2. 동의 철회 후에도 법령에 따라 보관해야 하는 정보는 관련 법령에서 정한 기간 동안 보관됩니다.

부칙

1. 본 동의서는 2024년 7월 1일부터 시행됩니다.',
           'TR002',
           true,
           false, now(), now()
       );